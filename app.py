...
/* === CSS CHO NAVIGATION BUTTON - PHIÊN BẢN MỚI THU NHỎ === */
.nav-container {{
    position: fixed;
    top: 50%;
    left: 50%;
...
.nav-btn {{
    ...
    background: linear-gradient(135deg, rgba(255, 215, 0, 0.95), rgba(255, 165, 0, 0.95)) !important;
    ...
    gap: 12px !important;
    overflow: hidden;
    box-shadow: 0 6px 20px rgba(255, 215, 0, 0.5), inset 0 0 15px rgba(255, 215, 0, 0.3) !important;
}}
...
.nav-btn:hover {{
    ...
    box-shadow: 0 8px 25px rgba(255, 215, 0, 0.7), 0 0 20px rgba(255, 215, 0, 0.6), inset 0 0 15px rgba(255, 215, 0, 0.4) !important;
}}
